...
@Component({
  selector: 'app-sodimac-quilicura',
  templateUrl: './sodimac-quilicura.page.html',
  styleUrls: ['./sodimac-quilicura.page.scss'],
})
export class SodimacQuilicuraPage implements OnInit {
  productos: Item = {
  nombre: '',
  precio: null,
  stock: null, 
...
async save_easy_costanera(){
  ...
  const enlace = 'sodimac_Quilicura';
  await this.database.createDocument<Item>(data, enlace, 'Quilicura');
...
getmostar(){
this.database.getCollection('sodimac_Quilicura').subscribe( res => {
