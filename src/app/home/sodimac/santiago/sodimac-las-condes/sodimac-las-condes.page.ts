...
@Component({
  selector: 'app-sodimac-las-condes',
  templateUrl: './sodimac-las-condes.page.html',
  styleUrls: ['./sodimac-las-condes.page.scss'],
})
export class SodimacLasCondesPage implements OnInit {
  productos: Item = {
  nombre: '',
  precio: null,
  stock: null, 
...
getmostar(){
this.database.getCollection('sodimac_condes').subscribe( res => {
