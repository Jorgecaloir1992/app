...
@Component({
  selector: 'app-sodimac-plaza-oeste',
  templateUrl: './sodimac-plaza-oeste.page.html',
  styleUrls: ['./sodimac-plaza-oeste.page.scss'],
})
export class SodimacPlazaOestePage implements OnInit {
  productos: Item = {
  nombre: '',
  precio: null,
  stock: null, 
...
async save_easy_costanera(){
  ...
  const enlace = 'sodimac';
  await this.database.createDocument<Item>(data, enlace, 'Plaza oeste');
