...
@Component({
  selector: 'app-sodimac-tobalaba',
  templateUrl: './sodimac-tobalaba.page.html',
  styleUrls: ['./sodimac-tobalaba.page.scss'],
})
export class SodimacTobalabaPage implements OnInit {
  productos: Item = {
  nombre: '',
  precio: null,
  stock: null, 
...
async save_easy_costanera(){
  ...
  const enlace = 'sodimac__San_Miguel';
  await this.database.createDocument<Item>(data, enlace, 'Tobalaba');
