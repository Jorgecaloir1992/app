...
@Component({
  selector: 'app-sodimac-quilin',
  templateUrl: './sodimac-quilin.page.html',
  styleUrls: ['./sodimac-quilin.page.scss'],
})
export class SodimacQuilinPage implements OnInit {
  productos: Item = {
  nombre: '',
  precio: null,
  stock: null, 
...
getmostar(){
this.database.getCollection('sodimac_Quilin').subscribe( res => {
