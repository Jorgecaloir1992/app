...
@Component({
  selector: 'app-sodimac-plaza-norte',
  templateUrl: './sodimac-plaza-norte.page.html',
  styleUrls: ['./sodimac-plaza-norte.page.scss'],
})
export class SodimacPlazaNortePage implements OnInit {
  productos: Item = {
  nombre: '',
  precio: null,
  stock: null, 
...
async save_easy_costanera(){
  ...
  const enlace = 'sodimac_Plaza_Norte';
  await this.database.createDocument<Item>(data, enlace, 'Plaza_Norte');
...
getmostar(){
this.database.getCollection('sodimac_Plaza_Norte').subscribe( res => {
