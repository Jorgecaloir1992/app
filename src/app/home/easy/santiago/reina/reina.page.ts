...
@Component({
  selector: 'app-reina',
  templateUrl: './reina.page.html',
  styleUrls: ['./reina.page.scss'],
})
export class ReinaPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  getmostar(){
  this.database.getCollection('easy_reina').subscribe( res => {
