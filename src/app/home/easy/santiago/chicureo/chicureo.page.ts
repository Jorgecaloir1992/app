...
@Component({
  selector: 'app-chicureo',
  templateUrl: './chicureo.page.html',
  styleUrls: ['./chicureo.page.scss'],
})
export class ChicureoPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  async save_easy_costanera(){
    ...
    const enlace = 'easy_chicureo';
    await this.database.createDocument<Item>(data, enlace, 'chicureo');
  ...
  getmostar(){
  this.database.getCollection('easy_chicureo').subscribe( res => {
