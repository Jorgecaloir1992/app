...
@Component({
  selector: 'app-quilicura',
  templateUrl: './quilicura.page.html',
  styleUrls: ['./quilicura.page.scss'],
})
export class QuilicuraPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  getmostar(){
  this.database.getCollection('easy_quilicura').subscribe( res => {
