...
@Component({
  selector: 'app-cerrillo',
  templateUrl: './cerrillo.page.html',
  styleUrls: ['./cerrillo.page.scss'],
})
export class CerrilloPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  getmostar(){
  this.database.getCollection('easy_bosque').subscribe( res => {
