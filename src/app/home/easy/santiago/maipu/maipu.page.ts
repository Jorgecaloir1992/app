...
@Component({
  selector: 'app-maipu',
  templateUrl: './maipu.page.html',
  styleUrls: ['./maipu.page.scss'],
})
export class MaipuPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  getmostar(){
  this.database.getCollection('easy_maipu').subscribe( res => {
