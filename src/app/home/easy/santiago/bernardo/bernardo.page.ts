...
@Component({
  selector: 'app-bernardo',
  templateUrl: './bernardo.page.html',
  styleUrls: ['./bernardo.page.scss'],
})
export class BernardoPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  async save_easy_costanera(){
    ...
    const enlace = 'easy_S_bernardo';
    await this.database.createDocument<Item>(data, enlace, 'San Bernardo');
  ...
  getmostar(){
  this.database.getCollection('easy_S_bernardo').subscribe( res => {
