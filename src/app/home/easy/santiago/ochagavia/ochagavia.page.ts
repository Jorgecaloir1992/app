...
@Component({
  selector: 'app-ochagavia',
  templateUrl: './ochagavia.page.html',
  styleUrls: ['./ochagavia.page.scss'],
})
export class OchagaviaPage implements OnInit {
  productos: Item = {
    nombre: '',
    precio: null,
    stock: null, 
  ...
  async save_easy_costanera(){
    ...
    const enlace = 'easy_ochagavia';
    await this.database.createDocument<Item>(data, enlace, 'Ochagavia');
  ...
  getmostar(){
  this.database.getCollection('easy_ochagavia').subscribe( res => {
