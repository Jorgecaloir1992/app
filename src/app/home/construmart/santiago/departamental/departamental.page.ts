...
@Component({
  selector: 'app-departamental',
  templateUrl: './departamental.page.html',
  styleUrls: ['./departamental.page.scss'],
})
export class DepartamentalPage implements OnInit {
  ...
  async save_easy_costanera(){
    ...
    const enlace = 'construmart_departamental';
    await this.database.createDocument<Item>(data, enlace, 'departamental');
  ...
  getmostar(){
  this.database.getCollection('construmart_departamental').subscribe( res => {
